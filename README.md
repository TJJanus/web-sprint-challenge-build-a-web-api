...
Node is used for back-end APIs services and used more on traditional websites.  It is JS on the server, it's async, and we have access to the NPM packages

1. Understand and explain the use of Middleware?
Middleware are functions that can do different things.  Such as hide headers for security reasons or validate data in our requests.
...
Express Routers help us group certain data together so that our request/server page is unmanagable.  The idea is to seperate the requests by their path.

1. Describe tooling used to manually test the correctness of an API.
WE used Postman to test requests through our API url.  We can do all of the CRUD operations with Postman or HTTPie.  
